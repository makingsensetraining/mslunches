namespace MSLunches.Infrastructure.Result
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Result{TSuccess, TError}"/> class for successful operations
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Result{TSuccess, TError}"/> class for failed operations
        /// </summary>
